...
# Physics truth version 48 keeps the v34 EM truth and uses the canonical-source-atlas v11
...
_unified_model.FORMAT_VERSION = 48
...
# v48 solves transported local sources on geometry-size/material-aware canonical thermal operators without replaying Maxwell truth.  The
...
_unified_runtime._CACHE_FORMAT = 51
