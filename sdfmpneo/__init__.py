...
# Physics truth version 47 keeps the v34 EM truth and uses the rigid-local-atlas v10
...
_unified_model.FORMAT_VERSION = 47
...
# v47 keeps the normalized/reference-energy local atlas but removes the regressive hard-coded size deformation.  The
...
_unified_runtime._CACHE_FORMAT = 50
