"""SDF-MPNEO unified full-space neural electrothermal solver."""
...
__all__ = [
    ...
    "edge_static_features", "generate_residual_dataset", "operator_feature_statistics",
    "residual_features", "sample_geometry", "stretched_axis", "train_maxwell_accelerator",
]
