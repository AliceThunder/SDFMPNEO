...
# Physics truth version 44 keeps the v34 EM truth and uses the stabilized v7
...
_unified_model.FORMAT_VERSION = 44
...
# v44 corrects thermal conditioning to use basis condition instead of its squared Gram condition.  The
...
_unified_runtime._CACHE_FORMAT = 47
