...
# Physics truth version 50 keeps the v34 EM truth and uses the hybrid-design-atlas v13
...
_unified_model.FORMAT_VERSION = 50
...
# v50 keeps canonical-source local truth and unions full-geometry with intrinsic/relative-pose maximin coverage.  The
...
_unified_runtime._CACHE_FORMAT = 53
