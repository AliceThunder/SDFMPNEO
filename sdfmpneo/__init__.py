...
# Physics truth version 49 keeps the v34 EM truth and uses the intrinsic-design-atlas v12
...
_unified_model.FORMAT_VERSION = 49
...
# v49 keeps canonical-source local truth and selects thermal training geometries modulo common rigid pose.  The
...
_unified_runtime._CACHE_FORMAT = 52
