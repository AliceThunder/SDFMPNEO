...
DEFAULT_GEOMETRY={
    "transmitter":{
        ...
        "conductor_width":0.0015,"conductor_thickness":0.001,
...
GEOMETRY_SAMPLING={
    "transmitter":{
        ...
        "turns":{"bounds":[0.5,3.0]},"outer_half_size":{"bounds":[0.012,0.045]},
        "pitch":{"bounds":[0.001,0.004]},"conductor_width":{"bounds":[0.0006,0.003]},
        "conductor_thickness":{"bounds":[0.0004,0.0025]},"corner_radius":{"bounds":[0.006,0.035]},
...
MATERIALS={
    ...
    "tx_package":{"electrical_conductivity":0.0,"resistivity_temperature_coefficient":0.0,"reference_temperature":293.15,"relative_permeability":1.0,"relative_permittivity":3.0,"thermal_conductivity":0.2,"volumetric_heat_capacity":1.5e6},
    "rx_package":{"electrical_conductivity":0.0,"resistivity_temperature_coefficient":0.0,"reference_temperature":293.15,"relative_permeability":1.0,"relative_permittivity":3.0,"thermal_conductivity":0.2,"volumetric_heat_capacity":1.5e6},
    "seawater":{"electrical_conductivity":5.0,"resistivity_temperature_coefficient":0.0,"reference_temperature":293.15,"relative_permeability":1.0,"relative_permittivity":80.0,"thermal_conductivity":0.6,"volumetric_heat_capacity":4.1e6},
}
REGIONS={"coil_materials":["tx_copper","rx_copper"],"package_materials":["tx_package","rx_package"],"seawater_material":"seawater"}
...
TRAINING={
    ...
    "optimizer":{"epochs":1000,"batch_size":128,"learning_rate":1e-3,"weight_decay":1e-6,"patience":150,"validation_interval":5,"seed":17,"dtype":"float32"},
}
...
MONITOR={
    ...
    "log_interval_s":1.0,"refresh_ms":300,"max_plot_points":4000,
    "compute_threads":1,"assembly_progress_interval_s":5.0,
}
...
SETTINGS={
    ...
    "THERMAL_RANK":THERMAL_RANK,"TRAINING":TRAINING,"PREDICTION":PREDICTION,"MONITOR":MONITOR,
}
