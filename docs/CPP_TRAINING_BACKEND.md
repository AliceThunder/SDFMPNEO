...
If compilation/loading fails, the exact historical Python implementation remains available.  Set `SDFMPNEO_CPP_DISABLE=1` to force that fallback for debugging.
